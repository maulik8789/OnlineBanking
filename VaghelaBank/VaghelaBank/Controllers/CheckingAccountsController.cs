...
namespace VaghelaBank.Controllers
{
    public class CheckingAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,AccountNumber,FirstName,LastName,Balance,ApplicationId")] CheckingAccount checkingAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,AccountNumber,FirstName,LastName,Balance,ApplicationId")] CheckingAccount checkingAccount)
        {
            if (ModelState.IsValid)
            {
